...
<li><a target="_blank" href="http://introcs.cs.princeton.edu/">Princeton University: Introduction to Programming in Java</a></li>
    <li><a target="_blank" href="http://algs4.cs.princeton.edu/home/">Princeton University: Algorithms, 4th Edition</a></li>
...
<li><a target="_blank" href="https://prismoskills.appspot.com/">Primo Skills</a></li>
    <li><a target="_blank" href="http://www.sorting-algorithms.com/">Sorting Algorithm Animations</a></li>
            ...
            <?php include('includes/shuffling.php'); ?>
            <?php include('includes/quicksort3Way.php'); ?>
            <?php include('includes/quicksortDP.php'); ?>
            <?php include('includes/quicksort.php'); ?>
            <?php include('includes/stack2Queues.php'); ?>
            <?php include('includes/heapsort.php'); ?>
            <?php include('includes/mergeSort.php'); ?>
            <?php include('includes/towerHanoi.php'); ?>
            <?php include('includes/shellSort.php'); ?>
            <?php include('includes/selectionSort.php'); ?>
            <?php include('includes/insertionSort.php'); ?>
            <?php include('includes/bubbleSort.php'); ?>
            <?php include('includes/maxSubmatrix.php'); ?>
            <?php include('includes/maxSubarray.php'); ?>
            <?php include('includes/symmetricTree.php'); ?>
