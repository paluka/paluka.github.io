    ...
    <title>Ray Tracer - Erik Paluka</title>
    <meta name="description" content="Web Ray Tracer">
...
<body onload="startRayTracing();">
    <div class="container">
        ...
        <div class="researchTitle">
            ...
            Computes the Lambertian Reflection &amp; Blinn-Phong Reflection<br>
Change the settings and click the button to render the scene again
        </div>
        <div id="raytracerCanvasContainer">
        <canvas id="raytracerCanvas" align="center" width="400" height="400"></canvas>
            </div>
        
                <div id="raytracerOptions">
                    <div id="raytracerText">Number of Spheres (min: 1 - max: 20):
                        <br/>Minimum Radius of the Spheres (min: 1 - max: 200): 
                        <br>Maximum Radius of the Spheres (min: 1 - max: 200):
                        <br>Width of the Canvas (min: 100px - max: 750px):
                        <br/>Height of the Canvas (min: 100px - max: 400px):
                        <br/>Minimum Sphere Reflection Ratio (min: 0.10 - max: 1.00):
                        <br/>Light 1 Colour (R, G, B - min: 0.00 - max: 1.00):
                        <br/>Light 2 Colour (R, G, B - min: 0.00 - max: 1.00):
                        <br/>Light 1 Position (X, Y, Z):
                        <br>Light 2 Position (X, Y, Z):
                        <br>Include Specular Reflection:
                        <br>Include Shadows:
                        <br>Include Plane:
                        <br>Plane Position (X, Y, Z):
                        <br>Plane Normal (nX, nY, nZ - min: -1.00 - max: 1.00):
                        <br>Plane Reflection Ratio (min: 0.10 - max: 1.00):
                    </div>
                    <div id="inputsContainer">
                        ...
                        <input class="checkBox" type="checkbox" id="includeSpec" checked>
                        <br>
                        <input class="checkBox" type="checkbox" id="includeShadows">
                        <br>
                ...
                <a onclick="restartRayTracing();">
                    <div class="button" id="raytracerButton">Ray Trace</div>
                </a>
