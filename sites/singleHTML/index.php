...
<html>
    ...
    <body>
        ...
        <div id="miniIcons">
            ...
            <a href="https://vialab.ca/portfolio/erik-paluka" target="_blank">
        ...
        <div class="Content textContent" id="BioContent">I am currently working on my
            <a href="http://www.gradstudies.uoit.ca/" title="UOIT Graduate Studies" target="_blank">master's degree in computer science</a> at the Univerisity of Ontario Institute of Technology (UOIT). I have been a member of the Visualization for Information Analysis lab (<a href="https://vialab.ca/" target="_blank" title="vialab research group">vialab</a>) under the supervision of
            <a href="https://vialab.ca/portfolio/christopher-m-collins" target="_blank">Dr. Christopher Collins</a> since May 2011.
            <br>
        ...
        <div class="Content textContent" id="ResearchContent">
            <div class="RowDivider">
                <div class="CellDivider" style="text-align: center; float:left; width: 306px;height:250px;"><a href="https://vialab.ca/portfolio/tandemtable" target="_blank">Tandem Table<br>Honours Undergraduate Thesis</a>
                    <br>
                    <br>Supervised by:
            ...
            <div class="RowDivider">
                <div class="CellDivider">
                    <span style="float:left; width: 306px;text-align: center;height:250px;">
                        <a href="https://vialab.ca/portfolio/smt-toolkit" target="_blank">The Simple Multi-Touch (SMT) Toolkit</a>
                        <br>
                        <br>Supervised by:
                        <br>Dr. Christopher Collins (UOIT)
        ...
        <div class="Content textContent" id="ContactContent">You can e-mail me at
            ...
            <br>You can also find me on
                            ...
                            <a href="https://vialab.ca/portfolio/erik-paluka" target="_blank">vialab research group</a>, and
