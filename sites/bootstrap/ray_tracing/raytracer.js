...
function startRayTracing() {
    ...
    document.getElementById('tracer').setAttribute("style","width: " + width + "px");
    document.getElementById('tracer').setAttribute("style","height: " + height + "px");
...
function getVariables() {
    ...
    canvas = document.getElementById("tracer");
